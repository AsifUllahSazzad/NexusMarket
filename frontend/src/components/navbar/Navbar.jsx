...
const Navbar = ({
  ...
  const screensList = [
    ...
    {
      id: "product-detail",
      label: "3. Product Detail (AeroPro)",
      icon: "headphones",
    },
  ...
  return (
    <header className="sticky top-0 z-50 bg-surface-container-lowest border-b border-outline-variant/60 shadow-xs transition-colors duration-200">
      {/* 1. Top Announcement Notification */}
      <div className="bg-surface-container-lowest border-b border-outline-variant/40 text-xs text-on-surface-variant py-2 px-gutter transition-colors duration-200">
          ...
          <div className="flex items-center gap-4 flex-shrink-0 text-xs">
            ...
            <div className="relative">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-primary/10 text-primary hover:bg-primary hover:text-on-primary transition-all font-semibold cursor-pointer"
            ...
            <a
              ...
              className="hover:text-primary transition-colors hidden md:inline text-on-surface-variant cursor-pointer"
            >
              Customer Service
            </a>
      ...
      <div className="w-full max-w-[1700px] mx-auto px-gutter py-3 flex items-center justify-between gap-4 md:gap-6">
        {/* Brand Logo */}
        <button
          type="button"
          ...
          <div className="w-full flex items-center bg-surface-container-lowest rounded-full border border-outline-variant hover:border-primary/60 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 pl-4 pr-1 py-1 transition-all shadow-xs">
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 text-xs font-label-md text-on-surface hover:text-primary pr-3 flex-shrink-0 focus:outline-none cursor-pointer"
              >
                ...
                >
                  {departments.map((dept) => (
                    <button
                      ...
                      className="w-full text-left px-3 py-1.5 text-xs text-on-surface hover:bg-surface-container-low transition-colors cursor-pointer"
                    >
                      {dept}
                    </button>
                  ))}
            ...
            {isAccountOpen && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2 text-xs text-on-surface hover:bg-surface-container-low transition-colors text-left cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-2 px-4 py-2 text-xs text-error hover:bg-surface-container-low transition-colors text-left cursor-pointer"
                >
                  <span className="material-symbols-outlined text-sm">
                    logout
                  </span>
      ...
      <nav className="bg-surface-container-lowest border-t border-outline-variant/30 transition-colors duration-200">
        <div className="w-full max-w-[1700px] mx-auto px-gutter flex items-center justify-between overflow-x-auto py-2.5 gap-6 no-scrollbar">
          <div className="flex items-center gap-7 text-xs font-label-md whitespace-nowrap">
            <button
              type="button"
              onClick={() => onNavigate("catalog")}
              className="flex items-center gap-2 text-on-surface font-bold hover:text-primary transition-colors pr-3 border-r border-outline-variant/40 cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={() => onNavigate("catalog")}
              className="text-on-surface hover:text-primary font-medium transition-colors cursor-pointer"
            >
              Deals of the Week
            </button>
            <button
          ...
          <div className="hidden md:flex items-center gap-4 text-xs font-label-md text-outline flex-shrink-0">
            <button
              ...
              className="text-on-surface-variant hover:text-primary transition-colors font-medium flex items-center gap-1.5 cursor-pointer"
            >
